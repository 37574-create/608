...
$username = "if0_42363940";
$password = "5EU1AddGuLxHW";
$dbname   = "if0_42363940_student";
...
<head>
    ...
    <title>งานที่ 2 - แสดงข้อมูลเฉพาะ ID 21</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="container my-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <a href="https://github.com/37574-create/608/blob/main/task2.php"_blank" class="btn btn-outline-dark">
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-info text-white">
            <h5 class="card-title mb-0">งานที่ 2: แสดงข้อมูลเฉพาะ ID = 21</h5>
        </div>
        <div class="card-body">
